...
def main(x_train,y_train,x_test,y_test):
	history = History()
	callbacks = [TensorBoard(log_dir='./logs', write_images = True,write_graph=True),\
	history]
	model = Sequential()
	...
	#sys.stdout = sys.__stdout__
	print('\nTrain...\n')
	model.fit(x_train, y_train,batch_size=batch_size,epochs=epochs,verbose = verbose,validation_data=(x_test, y_test),callbacks = callbacks)
